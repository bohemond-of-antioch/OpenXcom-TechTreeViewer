Public Class YamlNode
    ...
    Public Sub SetMapping(Name As String, Value As YamlNode)
        If Type <> EType.Mapping Then Throw New Exception("This Node is not a Mapping!")
        Mapping(Name) = Value
    End Sub
    ...
    Public Sub SetValue(Value As String)
        If Type <> EType.Value Then Throw New Exception("This Node is not a Value!")
        Me.Value = Value
    End Sub
    ...
    Public Sub AddItem(Value As YamlNode)
        If Type <> EType.Sequence Then Throw New Exception("This Node is not a Sequence!")
        Sequence.Add(Value)
    End Sub
